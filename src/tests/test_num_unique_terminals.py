...
def test_num_unique_terminals_7():
    assert Binary("neg", Terminal("ack_count"), Terminal("rate")).num_unique_terminals(__data) == 2

def test_num_unique_terminals_8():
    assert Binary("neg", Terminal("ack_count"), Terminal("ack_count")).num_unique_terminals(__data) == 1

def test_num_unique_terminals_9():
    assert Binary("neg", Terminal("ack_count"), Unary("abs", Terminal("ack_count"))).num_unique_terminals(__data) == 1

def test_num_unique_terminals_10():
    assert Binary("neg", Terminal("ack_count"), Binary("plus", Terminal("ack_count"), Terminal("rate"))).num_unique_terminals(__data) == 2

def test_num_unique_terminals_11():
    assert Binary("neg", Number(1.0), Binary("plus", Terminal("ack_count"), Terminal("ack_count"))).num_unique_terminals(__data) == 1